...
- **Hadith retrieval** — 36,104 hadith from 10 collections (Arabic + English): FTS5 BM25 + bge-m3 vectors, Reciprocal
...
```powershell
git clone <repo-url> sanadai; cd sanadai
...
Weak/fabricated gradings and alternatives: [Dorar.net](https://dorar.net), parsing ported from
...
| `data/seeds/circulating.txt` + `seed_report.jsonl` | `db/sanad.db` — `scripts/build_db.py`, `seed_dorar.py` |
